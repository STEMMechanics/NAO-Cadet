 ...
 */
Blockly.FlyoutButton.MARGIN = 10;
...
//   }
  ...
  this.width = Blockly.Field.getCachedWidth(svgText) * 1.5;
  this.height = this.isLabel_ ? 20 : 30;  // Can't compute it :(
...
//   }
  ...
  if(this.isLabel_) {
  	svgText.setAttribute('x', (this.width / 1.5) / 2);
  	svgText.setAttribute('y', this.height);
  } else {
