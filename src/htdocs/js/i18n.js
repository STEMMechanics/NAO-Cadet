...
var nao_i18n = {
	...
	ERROR_SETUP: {
		...
		IT: 'Si � verificato un errore durante l\'impostazione del cadetto NAO'
	},
	
	ERROR_LOGIN: {
		EN: 'The NAO could not log you in because an error occurred',
		IT: 'Il NAO non � riuscito ad accedere perch� si � verificato un errore'
	},
	
	ERROR_RENAME_FOLDER: {
		EN: 'Could not rename the folder because an error occurred',
		IT: 'Impossibile rinominare la cartella perch� si � verificato un errore'
	},
	
	ERROR_RENAME_FILE: {
		EN: 'Could not rename the file because an error occurred',
		IT: 'Impossibile rinominare il file perch� si � verificato un errore'
	},
	
	ERROR_LOADING_BEHAVIORS: {
		EN: 'There was a error getting the list of behaviors on the NAO',
		IT: 'Si � verificato un errore durante il recupero dell\'elenco dei comportamenti sul NAO'
	},
	
	ERROR_LOADING_MOVEMENT: {
		EN: 'There was a problem loading the movement',
		IT: 'Si � verificato un problema durante il caricamento del movimento'
	},
	
	ERROR_RUNNING_MOVEMENT: {
		EN: 'There was a problem running the movement',
		IT: 'Si � verificato un problema durante l\'esecuzione del movimento'
	},
	
	ERROR_MOVE_JOINTS: {
		EN: 'There was a problem moving the joints',
		IT: 'Si � verificato un problema durante lo spostamento delle articolazioni'
	},
	
	ERROR_SAVING_JOINTS: {
		EN: 'There was a problem saving the joints',
		IT: 'Si � verificato un problema durante il salvataggio delle articolazioni'
	},
	
	ERROR_LOADING_SOUNDS: {
		EN: 'There was a error getting the list of sounds on the NAO',
		IT: 'Si � verificato un errore durante il recupero dell\'elenco dei suoni sul NAO'
	},
	...
	ERROR_LOADING_MOTIONS: {
		...
		IT: 'Si � verificato un errore durante il recupero dell\'elenco dei movimenti sulla NAO'
	},
	
	ERROR_SAVING_MOTION: {
		EN: 'There was a problem saving the motion',
		IT: 'Si � verificato un problema durante il salvataggio del movimento'
	},
	
	ERROR_MOTION_EXISTS: {
		EN: 'You cannot use that name for this motion as it already exists',
		IT: '"Non puoi usare quel nome per questa mozione in quanto esiste gi�'
	},
	
	ERROR_MOTION_UPLOAD: {
		EN: 'An problem occurred trying to upload the motion',
		IT: 'Si � verificato un problema durante il tentativo di caricare il movimento'
	},
	
	ERROR_MOTION_DELETE: {
		EN: 'An problem occurred trying to delete the motion',
		IT: 'Si � verificato un problema durante il tentativo di eliminare il movimento'
	},
	
	ERROR_MOTION_EXPORT: {
		EN: 'An problem occurred trying to export the motion',
		IT: 'Si � verificato un problema durante il tentativo di esportare il movimento'
	},
	
	ERROR_SCRIPT_INFO: {
		EN: 'There was an error getting information about the script',
		IT: 'Si � verificato un errore durante il recupero delle informazioni sullo script'
	},
	
	ERROR_DELETE_SCRIPT: {
		EN: 'There was an error deleting the script',
		IT: 'Si � verificato un errore durante l\'eliminazione dello script'
	},
	
	ERROR_DELETE_PHOTOVIDEO: {
		EN: 'An problem occurred trying to delete the photo/video',
		IT: 'Si � verificato un problema durante il tentativo di eliminare la foto / il video'
	},
	
	ERROR_GET_FOLDERS: {
		EN: 'There was an error getting what folders are on %NAME%',
		IT: 'Si � verificato un errore durante il recupero delle cartelle su %NAME%'
	},
	
	ERROR_UPLOADING_FILE: {
		EN: 'There was an error uploading the file',
		IT: 'Si � verificato un errore durante il caricamento del file'
	},
	
	ERROR_SAVE_SCRIPT: {
		EN: 'Your script could not be saved because an error occurred',
		IT: 'Impossibile salvare lo script perch� si � verificato un errore'
	},
	
	ERROR_RUN_SCRIPT: {
		EN: 'An error occurred trying to run your script',
		IT: 'Si � verificato un errore durante il tentativo di eseguire lo script'
	},
	
	ERROR_GET_ORIGINAL_SCRIPT: {
		EN: 'There was an error getting the original script',
		IT: 'Si � verificato un errore durante il recupero dello script originale'
	},
	
	ERROR_SAVE_DUPLICATE_SCRIPT: {
		EN: 'There was an error saving the duplicate script',
		IT: 'Si � verificato un errore durante il salvataggio dello script duplicato'
	},
	...
	ERROR_CHANGE_PASSWORD: {
		...
		IT: 'Impossibile modificare la password perch� si � verificato un errore'
	},
	...
	ERROR_CHANGE_PASSWORD_INCORRECT: {		// Use %ACCOUNT% to insert reference account name
		...
		IT: 'La password corrente inserita non � corretta. La password per l\'account %ACCOUNT% non � stata modificata'
	},
	
	ERROR_SAVE_PROFILE: {
		EN: 'Your profile could not be saved because an error occurred. Your password has not been changed',
		IT: 'Impossibile salvare il profilo a causa di un errore. La tua password non � stata cambiata'
	},
	
	ERROR_GET_FILE_LIST: {
		EN: 'There was a error getting the list of files on the NAO',
		IT: 'Si � verificato un errore durante il recupero dell\'elenco dei file sul NAO'
	},
	
	ERROR_RECORDING: {
		EN: 'The NAO could not record audio because an error occurred',
		IT: 'Il NAO non � riuscito a registrare l\'audio a causa di un errore'
	},
	
	ERROR_SOUND_PLAYBACK: {
		EN: 'There was an error playing sound',
		IT: 'Si � verificato un errore durante la riproduzione del suono'
	},
	
	ERROR_DELETE_SOUND: {
		EN: 'There was an error deleting the sound',
		IT: 'Si � verificato un errore durante l\'eliminazione del suono'
	},
	
	ERROR_DELETE_FILE: {
		EN: 'There was an error deleting the file',
		IT: 'Si � verificato un errore durante l\'eliminazione del file'
	},
	
	ERROR_CLEAR_TEMP_FILES: {
		EN: 'There was an error clearing the temporary files from NAO Cadet',
		IT: 'Si � verificato un errore durante la cancellazione dei file temporanei dal cadetto NAO'
	},
	
	ERROR_RESTORE_FILE: {
		EN: 'A problem occurred trying to restore the file',
		IT: 'Si � verificato un problema durante il tentativo di ripristinare il file'
	},

	ERROR_RESTORE_SCRIPT: {
		EN: 'There was an error restoring the script',
		IT: 'Si � verificato un errore durante il ripristino dello script'
	},
	
	ERROR_RESTORE: {
		EN: 'An error occurred restoring NAO Cadet',
		IT: 'Si � verificato un errore durante il ripristino del cadetto NAO'
	},
	
	ERROR_BACKUP: {
		EN: 'An error occurred backing up NAO Cadet',
		IT: 'Si � verificato un errore durante il backup del cadetto NAO'
	},
	...
	ERROR_CREATE_LOCATION: {
		...
		IT: 'Si � verificato un errore durante la creazione della posizione'
	},
	
	ERROR_RENAME_LOCATION: {
		EN: 'Could not rename the location because an error occurred',
		IT: 'Impossibile rinominare la posizione perch� si � verificato un errore'
	},
	...
	ERROR_DELETE_LOCATION: {
		...
		IT: 'Si � verificato un problema durante il tentativo di eliminare la posizione'
	},
	...
	ERROR_RESTORE_LOCATION: {
		...
		IT: 'Si � verificato un problema durante il tentativo di ripristinare la posizione'
	},
	
	ERROR_RENAME_USER: {
		EN: 'An error occurred renaming the user',
		IT: 'Si � verificato un errore durante la ridenominazione dell\'utente'
	},
	
	ERROR_DELETE_USER: {
		EN: 'An problem occurred trying to delete the user',
		IT: 'Si � verificato un problema durante il tentativo di eliminare l\'utente'
	},
	
	ERROR_RESTORE_USER: {
		EN: 'An problem occurred trying to restore the user',
		IT: 'Si � verificato un problema durante il tentativo di ripristinare l\'utente'
	},
	
	ERROR_QUITTING_CADET: {
		EN: 'An problem occurred trying to quit NAO Cadet',
		IT: 'Si � verificato un problema durante il tentativo di uscire da Cadetto NAO'
	},
	...
	MSG_PASSWORD_CHANGED: {		// Use %ACCOUNT% to insert reference account name
		...
		IT: 'La password per l\'account %ACCOUNT% � stata modificata'
	},
	...
	MSG_SCRIPT_LOCKED: {
		...
		IT: 'Questo script � bloccato perch� � stato creato da qualcun altro o � attualmente in fase di modifica. <br> <br> Puoi visualizzare questo script, tuttavia dovrai salvarlo come copia'
	},

	MSG_RESTART_REQUIRED: {
		EN: 'There has been a system change with %NAME% and a restart of NAO Cadet is required',
		IT: 'Si � verificato un cambiamento di sistema con %NAME% ed � necessario il riavvio di Cadet NAO'
	},
	...
	MSG_WELCOME_NAO_CADET: {
		...
		IT: '%TIME_GREETING%, � bello essere a %LOCATION% <br> <br> Prima di iniziare, come ti chiami?'
	},
	...
	MSG_UNEXPECTED_DISCONNECT: {
		...
		IT: '%NAME% si � inaspettatamente disconnesso da noi. Potrebbe esserci un problema di rete o potrebbe essere necessario riavviare il NAO.'
	},
	...
	MSG_FIRST_TIME: {
		...
		IT: 'Abbiamo notato che questa � la prima volta che cado NAO � stato eseguito su %NAME% e abbiamo bisogno delle seguenti informazioni prima di continuare:'
	},
	...
	MSG_FIRST_TIME_LOCATION_INFO: {
		...
		IT: 'NAO Cadet identifica gli utenti e gli script per posizione. Se %NAME% si sposta in una posizione diversa, ci� non influir� sugli utenti e sugli script in questa posizione. <br> <br> Gli utenti potranno visualizzare gli script in altre posizioni, ma non modificarli'
	},
	...
	MSG_ADMIN_PASSWORD_INFO: {
		...
		IT: 'L\'account amministratore viene utilizzato per modificare le impostazioni del cadetto NAO ed eseguire attivit� in blocco'
	},
	...
	MSG_ROOT_PASSWORD_INFO: {
		...
		IT: 'L\'account <strong> root </strong> viene utilizzato come account di emergenza e pu� eliminare definitivamente i dati'
	},
	...
	MSG_LOCATION_SETTING: {
		...
		IT: 'Questo NAO � attualmente impostato per la posizione %LOCATION% e imposter� automaticamente gli script e gli utenti su %LOCATION%. <br> <br> Se questo non � corretto e si desidera modificarlo, accedere utilizzando < i> admin </i> e selezionare <i> Cambia posizione </i>'
	},
	...
	MSG_NO_PASSWORD_SET: {
		...
		IT: 'Nessuna password � stata impostata'
	},
	...
	MSG_CHANGE_DISCONNECT_USERS: {
		...
		IT: 'La modifica di questa impostazione forzer� la disconnessione di tutti gli utenti connessi'
	},
	...
	BLOCK_NAO_EVENT_BUMPER_LEFT: {
		...
		IT: 'quando il piede sinistro � premuto'
	},
	
	BLOCK_NAO_EVENT_BUMPER_RIGHT: {
		EN: 'when right foot pressed',
		IT: 'quando il piede destro � premuto'
	},
	...
	BLOCK_MOTION_SETJOINTALL: {
		...
		IT: 'imposta i giunti %1 sugli angoli %2 velocit� %3'
	},
